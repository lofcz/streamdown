...
import { PlantUmlDownloadDropdown } from "./download-button";
...
export const PlantUmlFullscreenButton = ({
  ...
  const showPanZoomControls = (() => {
    ...
    const plantumlCtl = controlsConfig.plantuml;
    if (plantumlCtl === false) {
      return false;
    }
    if (plantumlCtl === true || plantumlCtl === undefined) {
      return true;
    }
    return plantumlCtl.panZoom !== false;
  })();
  const showDownload = (() => {
    if (typeof controlsConfig === "boolean") {
      return controlsConfig;
    ...
    return plantumlCtl.download !== false;
  })();
      ...
      {isFullscreen
        ? createPortal(
            ...
            <div
              ...
              data-streamdown="plantuml-fullscreen"
              onClick={handleToggle}
              onKeyDown={(e) => {
                if (e.key === "Escape") {
                  handleToggle();
            ...
            >
              ...
              >
                {showDownload ? (
                  <PlantUmlDownloadDropdown chart={chart} config={config} />
                ) : null}
                <button
