  ...
  return (
    <div className="mx-auto max-w-prose px-4 py-12">
      ...
      <p className="mb-6 text-muted-foreground text-sm">
        Code blocks and tables render their horizontal-scroll region through
        the <code>scrollable</code> prop → OverlayScrollbars. Scroll
        horizontally inside each block to verify the overlay scrollbar
        appears (auto-hides on idle).
      </p>
